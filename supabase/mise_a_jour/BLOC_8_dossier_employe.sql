...
--
--  Ajoute : situation familiale et nombre d'enfants, photo de profil,
--  et le rangement des pièces signées (engagements de congé, contrats
--  légalisés) avec leurs deux espaces de stockage.
--
--  Les documents signés sont réservés au BUREAU et à l'ADMINISTRATEUR :
--  le responsable de paie n'y a pas accès.
-- ============================================================================
