-- ============================================================================
--  BLOC 14 sur 14 — Les chiffres de la paie dans Analytics
--  ============================================================
--  Supabase → SQL Editor → coller → Run.  À exécuter APRÈS le BLOC 13.
--
--  Ajoute la lecture des montants payés : mois par mois, cumul de
--  l'année, répartition espèces / virement, détail par banque et par
--  site principal, dettes en cours.
-- ============================================================================
