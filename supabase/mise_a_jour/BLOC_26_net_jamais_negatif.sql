-- ============================================================================
--  BLOC 26 sur 26 — Un net à payer ne peut pas être négatif
--  ============================================================
--  Supabase → SQL Editor → coller → Run. À exécuter APRÈS le BLOC 25.
--
--  Chaque montant était contrôlé séparément, jamais leur somme : une
--  retenue de 99 999 DH sur un salaire de 4 000 donnait un net de
--  −95 999,00 DH, accepté sans un mot et imprimé sur le bulletin.
-- ============================================================================
