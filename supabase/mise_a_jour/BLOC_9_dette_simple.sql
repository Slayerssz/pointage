-- ============================================================================
--  BLOC 9 sur 9 — Une seule dette par employé
--  ============================================================
--  Supabase → SQL Editor → coller → Run.  À exécuter APRÈS le BLOC 8.
--
--  La liste de dettes par employé est remplacée par UN montant sur sa
--  fiche. Dans la paie on saisit ce qu'on retient ce mois-ci (ex. 500) ;
--  à la validation, le solde baisse d'autant (1500 → 1000). Rouvrir le
--  mois remet le solde comme avant.
--
--  Les soldes existants sont repris automatiquement avant que les
--  anciennes tables ne soient retirées : rien n'est perdu.
-- ============================================================================
