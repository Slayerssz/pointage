-- ============================================================================
--  BLOC 25 sur 25 — Renommer une société ne casse plus ses documents
--  ============================================================
--  Supabase → SQL Editor → coller → Run. À exécuter APRÈS le BLOC 24.
--
--  Les contrats, en-têtes et mentions légales étaient retrouvés par le NOM
--  de la société : renommer « Groupe Triple A » en « GROUPE TRIPLE AAA »
--  faisait disparaître l'aperçu, sans message. Chaque société porte
--  désormais une clé de modèle indépendante de son nom d'affichage.
--
--  Après ce bloc, vérifiez qu'aucune société n'est restée sans clé :
--    select name, modele_document from public.companies order by name;
-- ============================================================================
