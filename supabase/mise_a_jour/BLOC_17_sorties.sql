-- ============================================================================
--  BLOC 17 sur 17 — Les sorties et le reçu pour solde de tout compte
--  ============================================================
--  Supabase → SQL Editor → coller → Run. À exécuter APRÈS le BLOC 16.
--
--  Un départ se prépare deux semaines à l'avance : on établit le reçu,
--  l'employé reste en poste et continue d'être pointé, et ce n'est qu'au
--  dernier jour qu'on valide. Valider ne supprime rien — la fiche garde
--  ses pointages et son historique de paie, elle quitte seulement les
--  listes actives.
-- ============================================================================
