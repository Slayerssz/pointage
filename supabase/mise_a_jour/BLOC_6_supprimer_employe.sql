-- ============================================================================
--  BLOC 6 sur 6 — Supprimer un employé (avec garde-fous)
--  ============================================================
--  Supabase → SQL Editor → coller → Run.  À exécuter APRÈS le BLOC 5.
--
--  Un employé déjà passé dans une paie n'est PAS supprimable : le
--  supprimer effacerait son historique de paie (tout est en cascade).
--  Dans ce cas, passez son statut à « Sorti ».
-- ============================================================================
