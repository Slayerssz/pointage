-- ============================================================================
--  BLOC 21 sur 21 — Deux types de contrat
--  ============================================================
--  Supabase → SQL Editor → coller → Run. À exécuter APRÈS le BLOC 20.
--
--  Il ne reste que « Contrat » et « Stage ». Les contrats déjà saisis sont
--  convertis : un stage reste un stage, tout le reste devient un contrat.
--  Les couleurs de fin de contrat ne bougent pas — elles n'ont jamais
--  dépendu du type, seulement des dates.
-- ============================================================================
