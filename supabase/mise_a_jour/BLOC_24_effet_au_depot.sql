-- ============================================================================
--  BLOC 24 sur 24 — Une pièce ne produit son effet qu'une fois signée
--  ============================================================
--  Supabase → SQL Editor → coller → Run. À exécuter APRÈS le BLOC 23.
--
--  Créer une pièce ne fait que l'enregistrer. C'est le dépôt du scan signé
--  qui la met en vigueur : les jours d'un congé s'inscrivent alors au
--  pointage, l'employé d'une sortie quitte alors les listes, un contrat
--  devient alors le contrat en cours. Retirer le scan défait exactement
--  cela.
-- ============================================================================
