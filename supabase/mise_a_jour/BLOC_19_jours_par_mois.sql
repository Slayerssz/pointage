-- ============================================================================
--  BLOC 19 sur 19 — Les jours travaillés du mois
--  ============================================================
--  Supabase → SQL Editor → coller → Run. À exécuter APRÈS le BLOC 18.
--
--  La colonne « Jours » de l'écran Employés montrait un compteur qui monte
--  depuis toujours. Elle montre désormais le mois choisi, lu dans les
--  pointages validés. Rien n'est stocké ni modifié.
-- ============================================================================
