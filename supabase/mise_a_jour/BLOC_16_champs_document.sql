-- ============================================================================
--  BLOC 16 sur 16 — Garder ce qui a été saisi sur les documents
--  ============================================================
--  Supabase → SQL Editor → coller → Run. À exécuter APRÈS le BLOC 15.
--
--  Deux colonnes seulement. Sans elles, réimprimer un contrat ou un
--  engagement six mois plus tard donnerait un document différent de celui
--  qui a été signé : le numéro du marché et les mentions en arabe ne sont
