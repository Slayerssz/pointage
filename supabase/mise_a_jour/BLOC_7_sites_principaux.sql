-- ============================================================================
--  BLOC 7 sur 7 — Sites principaux & annexes
--  ============================================================
--  Supabase → SQL Editor → coller → Run.  À exécuter APRÈS le BLOC 6.
--
--  Vos sites actuels deviennent des ANNEXES : rien n'est recréé, rien
--  n'est déplacé, aucun employé ne change de rattachement. On ajoute
--  seulement un niveau au-dessus, les SITES PRINCIPAUX, auxquels vous
--  rattachez ensuite les annexes de votre choix.
--
--  Ce bloc permet aussi de supprimer une annexe en déplaçant ses
--  employés vers une autre.
-- ============================================================================
